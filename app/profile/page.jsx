        ...
        <div className="max-w-6xl mx-auto px-4 space-y-8">
          ...
          <section className="bg-white rounded-3xl shadow-xl border border-slate-100 p-6 md:p-8 relative">
            ...
            <div className="absolute -top-12 left-1/2 -translate-x-1/2">
              <div className="h-24 w-24 rounded-full bg-slate-100 border-4 border-white flex items-center justify-center shadow-md">
                <svg
            ...
            >
              ...
              <div className="flex flex-col md:flex-row gap-3 md:gap-4 pt-2">
                {/* <button
                  type="button"
                  className="w-full md:w-1/3 h-11 rounded-xl border border-[#01559A] text-[#01559A] font-semibold hover:bg-blue-50 transition-colors"
                  onClick={() => {
                ...
                <div className="flex-1 flex justify-end">
                  <button
                    type="submit"
                    className="w-full md:w-40 h-11 rounded-xl bg-[#01559A] text-white font-semibold shadow-md hover:bg-blue-800 transition-colors"
                  >
                    Save
                  </button>
                </div>
            ...
            >
              ...
              <div className="flex flex-col md:flex-row gap-3 md:gap-4 pt-2 md:items-center md:justify-between">
                <p className="text-xs text-slate-500">
                  Setelah password diganti, kamu mungkin diminta login ulang di
                  beberapa device.
                </p>
                <button
                  type="submit"
                  className="w-full md:w-48 h-11 rounded-xl bg-[#01559A] text-white font-semibold shadow-md hover:bg-blue-800 transition-colors"
                >
                  Update Password
                </button>
              </div>
